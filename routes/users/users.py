...
def edit_user():
    """
    Edit user by user id or username.

    Args:
        user_id (arg): The user id of the user.
        username (arg): The username of the user.
    ...
    Returns:
        (dict): {
            'user': {
                ...
                'username': (str) user username,
                'email': (str) user email,
                'authenticated': (bool) user authenticated status,
                'last_login': (datetime) user last login,
                'created_on': (datetime) user created on,
                'avatar_url': (str) user avatar url
            }
...
def delete_all_users():
    ...
    Returns:
        (dict): {
            'numberOfDeletedUsers': (int) The number of deleted users
        }
    """
